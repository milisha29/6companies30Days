...
public:
    ...
    {       //First form a graph considering prerequisites as directed edges
        ...
        //Also we need to find topological ordering which says that if u->v edge then u comes before v  thus we make edge such that u course is to be done before v
            vector<int>ans;
        vector<int>adj[n];
